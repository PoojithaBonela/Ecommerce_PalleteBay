        ...
        function searchPaintings() {
            ...
            const paintings = document.querySelectorAll('.product-card');
            ...
            paintings.forEach(painting => {
              ...
              // Check if any word in the search input matches part of the title
        ...
        document.addEventListener('DOMContentLoaded', async () => {
          try {
            ...
            if (user) {  // Remove the user.id check since we're already checking auth on server
              // User is logged in
        ...
        // Update logout button to include credentials
